                ...
                <div className='w-3/5 m-auto flex flex-col justify-center h-full gap-[5%] bg-transparent space-y-8'>
                    ...
                    <div className="space-y-3 w-full">
                        <div className="flex flex-row gap-5">
                            ...
                            <div className="badge badge-accent badge-outline text-lg p-5">Symfony</div>
                            <div className="badge badge-accent badge-outline text-lg p-5">Node.js</div>
                            <div className="badge badge-accent badge-outline text-lg p-5">Nest.js</div>
                        </div>
                        <div className="flex flex-row gap-5">
                            <div className="badge badge-accent badge-outline text-lg p-5">API Integration</div>
                            <div className="badge badge-accent badge-outline text-lg p-5">Flutter</div>
                            <div className="badge badge-accent badge-outline text-lg p-5">Tailwind</div>
                        </div>
                        <div className="flex flex-row gap-5">
                            <div className="badge badge-accent badge-outline text-lg p-5">Docker</div>
                            <div className="badge badge-accent badge-outline text-lg p-5">Postgres SQL</div>
